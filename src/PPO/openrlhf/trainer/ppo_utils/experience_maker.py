...
class NaiveExperienceMaker(ABC):
    ...
    def generate_samples(self, all_prompts: List[str], **generate_kwargs) -> List[Samples]:
        ...
        samples_list = []
        for i in tqdm(range(0, len(all_prompts), args.micro_rollout_batch_size)):
...
# class MultipleRewardExperienceMaker(NaiveExperienceMaker):
...
#     @torch.no_grad()
#     def make_experience_list(self, all_prompts: Union[str, List[str]], labels: Union[str, List[str]], **generate_kwargs) -> List[Experience]:
#         """
#         Make a list of experience with the micro_rollout_batch_size.
...
#             disable=not self.strategy.is_rank_0(),
#         ):
#             experiences.append(self.make_experience(samples, l))
...
#     @torch.no_grad()
#     def make_experience(self, samples: Samples, label) -> Experience:
#         self.actor.eval()
#         self.initial_model.eval()
#         if self.reward_model is not None:
...
#         rewards = []
#         for rm in self.reward_model:
#             rewards.append(rm(sequences, attention_mask))
