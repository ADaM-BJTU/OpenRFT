...
from openrlhf.trainer.rft_trainer import RFTTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="openrlhf_train_rft")
    parser.add_argument(
        "--wandb_run_name",
        type=str,
        default="rft_add_prm_%s" % datetime.now().strftime("%m%dT%H:%M"),
    )
